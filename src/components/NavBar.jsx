        ...
        <div className={'w-full py-10 flex items-center justify-between'}>
            ...
            <div className={'flex'}>
                <ul className={'flex items-center gap-4'}>
                    ...
                    <li className={'p-2 rounded-full bg-gray-900'}><a href="https://dexscreener.com/solana/6RfBTrFyttmGuRCdRgx1veeqP2g5wFB6cG9mUuiKkejS">
                        <img className={"w-6 h-6"} src={dex} alt="dex-image"/>
                    </a></li>
                    <li className={'p-2 rounded-full bg-gray-900'}><a href="https://www.dextools.io/app/en/solana/pair-explorer/6RfBTrFyttmGuRCdRgx1veeqP2g5wFB6cG9mUuiKkejS?t=1720912494004">
                        <img className={"w-6 h-6"} src={dextool} alt="dex-image"/>
                    </a></li>
                </ul>
            </div>
        </div>
